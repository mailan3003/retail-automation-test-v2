...
${PRODUCT_ID_MATERIAL}   1000016616
...
${PROMOTION_ID_19}      91937
${CUSTOMER_GROUP_PROMOTION_ID}    1000009229
${DELETE_PROMOTION_ID}    87292
${DELETE_PROMOTION_CODE}    PRO002
${DELETE_PROMOTION_NAME}    Khuyến mại hàng hóa
...
${STATUS_CANCELLED}      4
${STATUS_FAILED}         5
${INVOICE_ID_VOID}      1000015224

# KvParterDelivery
${KV_PARTNER_DELIVERY_ID_WRONG_SCOPE}    100025
${KV_PARTNER_DELIVERY_CODE_WRONG_SCOPE}    AUTOMATIONTEST
${NON_EXISTENT_KV_PARTNER_DELIVERY_ID}    9999999
${NON_EXISTENT_KV_PARTNER_DELIVERY_CODE}    AUTOMATIONTEST123

${GHN_PARTNER_DELIVERY_ID}    6
