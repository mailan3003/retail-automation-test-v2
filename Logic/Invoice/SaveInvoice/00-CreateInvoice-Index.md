...
19. [Chi tiết phương thức MakeInvoiceAsync](./19-CreateInvoice-MakeInvoiceAsync-Index.md)
    - [Chuẩn bị dữ liệu và chuẩn hóa](./19-1-MakeInvoice-Initialization.md)
    - [Xử lý hóa đơn offline](./19-2-MakeInvoice-OfflineInvoice.md)
    - [Xác thực đơn hàng](./19-3-MakeInvoice-OrderValidation.md)
    - [Xử lý lô sản phẩm](./19-4-MakeInvoice-BatchProcessing.md)
    - [Xử lý cập nhật hóa đơn](./19-5-MakeInvoice-UpdateInvoice.md)
    - [Kiểm tra và cảnh báo công nợ khách hàng](./19-6-MakeInvoice-CustomerDebt.md)
    - [Xác thực mã khuyến mãi và voucher](./19-7-MakeInvoice-CouponVoucher.md)
    - [Tạo hóa đơn và xử lý thanh toán](./19-8-MakeInvoice-InvoicePayment.md)
    - [Xử lý giao hàng](./19-9-MakeInvoice-DeliveryProcessing.md)
    - [Cập nhật đơn hàng và tài liệu](./19-10-MakeInvoice-OrderDocumentUpdate.md)
    - [Phân bổ thanh toán](./19-11-MakeInvoice-PaymentAllocation.md)
    - [Theo dõi sự kiện](./19-12-MakeInvoice-EventTracking.md)
    - [Đồng bộ với hệ thống bên ngoài](./19-13-MakeInvoice-ExternalSync.md)
    - [Xử lý đơn thuốc](./19-14-MakeInvoice-Prescription.md)
    - [Xử lý lỗi và ngoại lệ](./19-15-MakeInvoice-ErrorHandling.md)
