...
RT-RC-001 Tạo phiếu thu tiền mặt khi tạo hóa đơn
    ...
    Given Chuẩn Bị Dữ Liệu Hóa Đơn Tiêu Chuẩn Với Thanh Toán    ${PAYMENT_CASH}    100000
...
RT-RC-002 Tạo phiếu thu với thanh toán bằng thẻ
    ...
    ...    - Tổng tiền thanh toán của hóa đơn = 100,000đ
    ...    - Công nợ của hóa đơn = 0
    Given Chuẩn Bị Dữ Liệu Hóa Đơn Tiêu Chuẩn Với Thanh Toán    ${PAYMENT_CARD}    100000
    When Gửi Yêu Cầu Tạo Hóa Đơn
    Then Response Status Code Should Be 200
    And Response Should Have Id exist
    And Xác Thực Phiếu Thu Được Tạo Với Số Tiền 100000
    And Xác Thực Thanh Toán Được Ghi Nhận    None    ${PAYMENT_CARD}    100000
    And Xác Thực Tổng Tiền Thanh Toán Của Hóa Đơn    None    100000
    And Xác Thực Công Nợ Của Hóa Đơn    None    0
...
RT-RC-003 Tạo phiếu thu với thanh toán bằng chuyển khoản
    ...
    ...    - Tổng tiền thanh toán của hóa đơn = 100,000đ
    ...    - Công nợ của hóa đơn = 0
    Given Chuẩn Bị Dữ Liệu Hóa Đơn Tiêu Chuẩn Với Thanh Toán    ${PAYMENT_TRANSFER}    100000
    When Gửi Yêu Cầu Tạo Hóa Đơn
    Then Response Status Code Should Be 200
    And Response Should Have Id exist
    And Xác Thực Phiếu Thu Được Tạo Với Số Tiền 100000
    And Xác Thực Thanh Toán Được Ghi Nhận    None    ${PAYMENT_TRANSFER}    100000
    And Xác Thực Tổng Tiền Thanh Toán Của Hóa Đơn    None    100000
    And Xác Thực Công Nợ Của Hóa Đơn    None    0
...
RT-RC-004 Tạo phiếu thu với nhiều phương thức thanh toán
    ...
    ...    - Tổng tiền thanh toán của hóa đơn = 100,000đ
    ...    - Công nợ của hóa đơn = 0
    Given Chuẩn Bị Dữ Liệu Hóa Đơn Với Nhiều Phương Thức Thanh Toán    50000    50000
    When Gửi Yêu Cầu Tạo Hóa Đơn
    Then Response Status Code Should Be 200
    And Response Should Have Id exist
    And Xác Thực Phiếu Thu Được Tạo Với Số Tiền 100000
...
RT-RC-005 Tạo phiếu thu với thanh toán thừa
    ...
    ...    - Công nợ của hóa đơn = 0
    Given Chuẩn Bị Dữ Liệu Hóa Đơn Với Thanh Toán Thừa    120000
    When Gửi Yêu Cầu Tạo Hóa Đơn
    Then Response Status Code Should Be 200
    And Response Should Have Id exist
...
RT-RC-006 Tạo phiếu thu với thanh toán thiếu
    ...
    And Xác Thực Tổng Tiền Thanh Toán Của Hóa Đơn    None    80000
...
RT-RC-011 Tạo phiếu thu với số tiền lớn
    ...
    ...    - Công nợ của hóa đơn = 0
    Given Chuẩn Bị Dữ Liệu Hóa Đơn Tiêu Chuẩn Với Thanh Toán    ${PAYMENT_CASH}    9999999
    When Gửi Yêu Cầu Tạo Hóa Đơn
    Then Response Status Code Should Be 200
    And Response Should Have Id exist
...
RT-RC-012 Tạo phiếu thu thanh toán một phần bằng các phương thức khác nhau
    ...
    And Xác Thực Công Nợ Của Hóa Đơn    None    40000 