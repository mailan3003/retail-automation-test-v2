...
Nhập hàng thành công với nhiều hàng hóa
    ...
    And Lấy tồn kho hàng hóa trước khi nhập hàng
    ...
    And Kiểm tra tồn kho hàng hóa sau khi nhập hàng
    [Teardown]    Xóa phiếu nhập hàng
...
Nhập hàng thất bại do Id sản phẩm = 0
    ...
    And Kiểm tra message lỗi chứa Không tìm thấy sản phẩm ${ProductCode1} (có thể đã bị xóa)
